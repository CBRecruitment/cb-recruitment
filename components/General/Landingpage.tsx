      ...
      <div className='left-dim'>
        <div className='w-full h-full flex flex-col items-center justify-center'>
          <div className='text-center text-gray-800 lg:mr-32'>
            <h1 className='text-3xl tracking-wider'>I am exploring jobs in the</h1>
            <h1 className='text-3xl font-bold tracking-wider'>crypto | blockchain | web3</h1>
      ...
      <div className='right-dim'>
        <div className='w-full h-full flex flex-col items-center justify-center'>
          <div className='text-center text-white lg:ml-32'>
            <h1 className='text-3xl tracking-wider'>I am hiring for a</h1>
            <h1 className='text-3xl font-bold tracking-wider'>crypto | blockchain | web3</h1>
