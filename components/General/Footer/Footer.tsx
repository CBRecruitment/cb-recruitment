    ...
    <footer className='bg-[var(--darkgray)] h-full'>
      <div className='flex justify-center pt-10'>
        <Link href='/' className='flex justify-center items-center'>
          <Image src={'/assets/branding/cblogo-whitev2.png'} alt='CBR Logo' width={55} height={0} className='' />
        </Link>
        <div className='flex flex-col justify-center items-center w-48 leading-5'>
          <h1 className='text-white text-[20px] font-semibold  '>CB RECRUITMENT</h1>
          <h2 className='text-white text-[18px] font-thin'>MAKING WEB3 WORK</h2>
        </div>
      </div>
      ...
      <div className='w-[90%] sm:w-[70%] md:w-[60%] lg:w-[50%] xl:w-[30%] m-auto pb-10'>
        ...
        <small className='text-white flex justify-center mt-5'>&#169; All Rights Reserved to CBRecruitment 2023</small>
      </div>
    </footer>
  );
};
