...
const Footer = () => {
  return (
    <footer className={clsx('h-full bg-[var(--darkgray)] bg border-t-[1px]', styles.bg)}>
      <div className='md:flex md:p-6 lg:py-20'>
        <div className='md:w-fit md:mx-auto'>
          <div className='flex justify-center pt-10 h-fit'>
            <Link href='/' className='flex justify-center items-center'>
              <Image src={'/assets/branding/cblogo-whitev2.png'} alt='CBR Logo' width={55} height={0} />
            </Link>
            <div className='flex flex-col justify-center items-center w-48 leading-5'>
              <h2 className='text-white text-[20px] font-semibold'>CB RECRUITMENT</h2>
              <h3 className='text-white text-[18px] font-thin'>MAKING WEB3 WORK</h3>
            </div>
          </div>
          <div className='flex flex-col items-center pt-4 text-white md:flex md:flex-col md:w-full md:pl-20 md:pt-6 md:tracking-wide'>
            {/* <h3 className='text-[20px] Roboto-Bold'>COMPANY INFORMATION</h3>
            <p>Address xxxx</p>
            <p>info@cbrecruitment.com</p> */}
            <div className='flex space-x-6 opacity-80 pt-3 xl:space-x-4'>
        ...
        <div className='md:flex md:mx-auto'>
          {/* <hr className='bg-white opacity-90 mt-10 mx-28 p-[0.5px]' /> */}
          <section className='flex flex-col justify-center items-center mt-10'>
            <h3 className='Roboto-Bold text-white tracking-widest'>LOREM IPSUM</h3>
        ...
        <div className='w-[80%] sm:w-[70%] md:w-[30%] xl:w-[25%] 2xl:w-[20%] mx-auto pb-10'>
          <div className='flex flex-col mx-auto bg-[var(--cream)] rounded-2xl p-4 mt-10'>
            <span className='text-black mb-2 font-bold text-xl'>News Letter</span>
