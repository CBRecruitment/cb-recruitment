        ...
        <div className='top-border-shadow bg-white h-full'>
            <div className='relative h-[400px] w-[320px] m-auto '>
                <Image
                    ...
                    width={'100'}
                    height={'0'}
                    className='absolute pt-10 left-[10px] lady'
                />
                <div className='absolute top-[45px] left-[120px] w-fit Roboto-Bold top-text'>
                    <h3 className='text-2xl'>NEW</h3>
                    <h2 className='text-3xl tracking-wide'>TO WEB3</h2>
                </div>
                <div className='absolute top-[130px] left-[130px] w-[200px] text-xl tracking-wide Roboto-Bold bottom-text'>
                ...
                <Image
                    ...
                    width={'140'}
                    height={'0'}
                    className='absolute top-[285px] left-[80px] dotted_square'
                />
                <Image
                    ...
                    width={'250'}
                    height={'0'}
                    className='absolute top-[245px] right-[28px] w-[250px] dotted_line'
                />
                <div className='w-fit absolute top-[305px] right-[20px] button'>
