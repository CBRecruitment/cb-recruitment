  ...
  return (
    <div className={clsx('bg-white', styles.shadow)}>
      <div className={clsx('relative h-[400px] w-[320px] m-auto', styles.container)}>
        ...
        />
        <div className={clsx('absolute top-[45px] left-[110px] w-fit Roboto-Bold', styles.top_text)}>
        ...
        <Image
          ...
          width={'140'}
          height={'0'}
          className={clsx('absolute top-[285px] left-[45px]', styles.dotted_square)}
        />
        <Image
          ...
          width={'250'}
          height={'0'}
          className={clsx('absolute top-[245px] right-[30px] w-[200px]', styles.dotted_line)}
        />
        <div className={clsx('w-fit absolute top-[305px] right-[10px]', styles.button)}>
