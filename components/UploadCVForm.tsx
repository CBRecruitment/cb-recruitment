...
const PublicForm = () => {
    return (
        <div className='bg-blue-500 w-[75%] mx-auto border-white rounded-md border-4 w text-black font-medium py-5 '>
            <form
            ...
            >
                ...
                <button
                    className='border-2 border-black bg-white rounded-md p-2 w-[80%] mx-auto font-bold mt-4'
                    type='submit'
                >
                    Send Application
                </button>
