    ...
    <div>
      <div className='h-full relative pt-4 mt-10'>
        ...
        <div className=' flex flex-col items-center justify-center w-[200px] md:w-[400px] xl:w-[510px] mx-auto'>
          ...
          <p className='text-sm md:text-lg xl:text-2xl font-extralight text-center'>
        ...
        <div className='flex flex-col md:flex-row md:justify-center md:space-x-6 xl:space-x-8'>
          <div className='text-center z-10'>
            <div className='bg-[var(--orange)] h-[160px] w-[160px] xl:h-[200px] xl:w-[200px] xl:mt-16 mt-8 md:mt-6 mx-auto 2xl:h-[240px] 2xl:w-[240px]'></div>
            <h4 className='font-semibold text-2xl pt-2'>John Doe</h4>
            <span className='font-extralight'>Job Title</span>
          </div>
          <div className='text-center z-10'>
            <div className='bg-[var(--orange)] h-[160px] w-[160px] xl:h-[200px] xl:w-[200px] xl:mt-16 mt-6 mx-auto 2xl:h-[240px] 2xl:w-[240px]'></div>
            <h4 className='font-semibold text-2xl pt-2'>John Doe</h4>
            <span className='font-extralight'>Job Title</span>
          </div>
          <div className='text-center z-10'>
        ...
        {expandTeam && (
          <div className='flex flex-col md:flex-row md:justify-center md:z-auto md:space-x-6 md:pt-10 xl:space-x-8'>
            <div className='text-center z-10'>
              <div className='bg-[var(--orange)] h-[160px] w-[160px] xl:h-[200px] xl:w-[200px] xl:mt-10 mt-8 md:mt-6 mx-auto 2xl:h-[240px] 2xl:w-[240px]'></div>
              <h4 className='font-semibold text-2xl pt-2'>John Doe</h4>
              <span className='font-extralight'>Job Title</span>
            </div>
            <div className='text-center z-10'>
              <div className='bg-[var(--orange)] h-[160px] w-[160px] xl:h-[200px] xl:w-[200px] xl:mt-10 mt-6 mx-auto 2xl:h-[240px] 2xl:w-[240px]'></div>
              <h4 className='font-semibold text-2xl pt-2'>John Doe</h4>
              <span className='font-extralight'>Job Title</span>
            </div>
            <div className='text-center z-10'>
