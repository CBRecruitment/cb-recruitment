  ...
  return (
    <div style={{backgroundColor: `${color}`}} className='fixed left-0 top-0 w-full z-10 ease-in duration-300'>
      <div className='max-w-[1240px] m-auto flex justify-between items-center p-4 text-white'>
        <Link href="/">
          <Image src={"/assets/cblogo.png"} alt="CBR Logo" width={55} height={50}/>
        </Link>
        <ul style={{color: `${textColor}`}} className='hidden sm:flex'>
          ...
          <li className='p-4 hover:text-blue-600 ease-in duration-100 hover:underline underline-offset-8 decoration-blue-600 hidden md:flex'>
           ...
           <li className='p-4 hover:text-blue-600 ease-in duration-100 hover:underline underline-offset-8 decoration-blue-600 hidden lg:flex'>
            ...
            <ConnectButton/>
            <Image className='ml-5 m-auto hover:animate-bounce' src={"/assets/search-white.png"} alt="Search button" width={20} height={25}/>
        </ul>
        ...
        {/* Mobile Menu */}
        <div className={`sm:hidden absolute top-0 ${nav ? 'left-0' : 'left-full'} right-0 bottom-0 flex justify-center items-center w-full h-screen bg-black border-gray-400 text-center ease-in duration-300`}>
          <ul>
