  ...
  return (
    <>
      <div className='relative text-black'>
        <div className='md:bg-[#f6d818] w-[205px] h-[775px] ml-[205px] mb-10'></div>
        <Image
        ...
        <article className='absolute top-10 right-10 w-[390px] space-y-6 Roboto-Light py-10'>
          ...
          <p>
            Are you a company eager to shorten the hiring process, streamline the best candidates and increase engagement and
            retention by hiring the right people at the right time for the right job?
          </p>
          <p>We've got you.</p>
          <p>
          ...
          <p>
            We believe we are the global leaders in the specialist Web3 recruitment field, and if you work with us, you'll
        ...
        <div>
          <div className='flex flex-col relative'>
            <section className='bg-gradient-to-r from-[#eda238] to-[#f6d715] h-[250px]'>
              <h2 className='text-3xl tracking-wide text-white flex justify-center pt-12 '>START YOUR WEB3 CAREER</h2>
            </section>
            ...
            <div className='h-[950px]'>
              <article className='absolute top-[450px] left-[160px]'>
                ...
                <section className='w-[380px] space-y-6 Roboto-Light pt-6'>
                  <p>People are at the heart of everything we do.</p>
                  <p>
                    CB Recruitment believes in the future of Web3 and helping people to transition into the space.
                    Subsequently, we nurture candidates throughout their careers and help companies find top-tier Web3
                    talent.
                  </p>
                  <p>
                  ...
                  <p>
                    We work to connect industry-leading talent with some of the leading companies in the crypto and
                    blockchain space, and we treat every candidate as an individual.
                  </p>
                  <p>
            ...
            <div className='bg-black h-[200px] w-[150px] absolute bottom-0 left-0'></div>
            <div className='bg-black h-[200px] w-[150px] absolute bottom-0 right-0'></div>
            <div className=' flex flex-col items-center justify-center pb-24'>
              <section className='flex space-x-3 justify-center items-center tracking-wide'>
                <h2 className='text-7xl Roboto-Bold'>Meet</h2>
                <h3 className='text-2xl font-light'>the</h3>
                <h2 className='text-7xl Roboto-Bold'>Team</h2>
              </section>
              <p className='text-lg font-light mt-[-5px]'>RESPONSIBLE FOR MAKING THE MAGIC HAPPEN</p>
            </div>
          </div>
        </div>
      </div>
