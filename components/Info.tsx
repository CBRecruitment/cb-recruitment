  ...
  return (
    <div className='w-full py-16 px-4 mx-auto'>
      <div
        ref={ref}
        className={`${
          inView ? 'animate-in slide-in-from-right delay-100 duration-1000' : ''
        }`}
      >
        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
          ...
          <div className='flex flex-col justify-center md:mt-8 lg:mt-0'>
            <p className='font-medium text-center mx-auto max-w-[85%] md:text-md'>
              CBRecruitment is a team of experienced recruiters specializing in
              the crypto and blockchain space. We have a reputation as the
              leading talent acquisition service in the Web3 space, and our team
              is supported by The Coin Bureau, an industry influencer and
              educator. Our expertise helps you find top talent in this rapidly
              growing field.
            </p>
            <Link href='/contact'>
