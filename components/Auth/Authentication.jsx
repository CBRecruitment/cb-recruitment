    ...
    return (
      <div className='hidden md:flex '>
        <div className=' text-white cursor-pointer w-32 flex justify-evenly items-center'>
          <BsPerson size={25} />
          <p className='text-[var(--orange)] capitalize text-lg'>{user?.nickname}</p>
          ...
          {open && (
            <div className='absolute '>
              ...
              >
                <a className='w-full border-b-2 p-3 pl-3 hover:bg-[#4f5961]' href='/profile'>
                  <li>
                ...
                <li className='w-full border-b-2 p-3 pl-3 hover:bg-[#4f5961]'>Post a job</li>
                <li className='w-full border-b-2 p-3 pl-3 hover:bg-[#4f5961]'>Saved jobs</li>
